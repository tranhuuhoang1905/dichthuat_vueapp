                ...
                <div class="col-md-6 col-sm-12">
                  <div class="form-group">
                    ...
                    <vue3-simple-typeahead
                      class="border border-1 p-0 ps-3"
                      id="typeahead_id"
                    ...
                    >
                      <template #list-item-text="slot" :class="{ hidden: true }"
                        ><span
                          v-html="
                ...
                <div class="col-md-6 col-sm-12">
                  ...
                  <div class="form-group">
                    ...
                    <textarea
                      ...
                      placeholder="Enter description"
                      class="form-control"
                      v-model="FormData.translate_description"
                      rows="4"
                      required
                    ></textarea>
                  </div>
                  <div class="form-group">
                    ...
                    <select
                      class="form-select"
                      aria-label="Default select example"
                      v-model="FormData.language_translate_id"
                      required
                    >
                      <option
                        v-for="language in languages"
        ...
        <div class="row">
              ...
              <div class="word-content">
                <div class="box_mean">
                  ...
                  <div class="box_mean_router">
                    <router-link
                      :to="{ name: 'Edit Word', params: { id: wordId } }"
          ...
          <div class="col-md-8">
            ...
            <div class="shadow-lg border border-0 word-default-data">
              <div
                class="word-content"
                v-for="(translate, index) in translatesDefault"
                :key="index"
              >
                <hr v-if="index > 0" />
                <div class="icon_dot">
                  {{ index + 1 }}) &nbsp;<span class="box_mean-language"
                    >Language: {{ translate.language }}</span
                  >
                </div>
                <div class="box_mean">
