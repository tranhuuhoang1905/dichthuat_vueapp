  ...
  <div class="translate_word_from_excel">
    <div class="row">
      <div class="card show border border-0">
        <div class="card-body">
          <h4 class="card-title text-center fs-4">Translate Word From Excel</h4>
          <div class="col-md-12 d-flex flex-column align-items-center">
            <form @submit.prevent="translateWordsFromExcel">
              ...
              <p>
                *: Provide an Excel file with the words you want to translate in
                column A. We'll send back a file with search results in column B
                (blank if the word isn't in our database).
              </p>
            </form>
          </div>
        </div>
