      ...
      <form class="mb-4" @submit.prevent="searchAction">
        <div class="translate-body">
          <div class="custom-search">
            ...
            />
            <div
              @click.prevent="showKeyboard = !showKeyboard"
              class="btn-keyboard"
            >
        ...
        />
        <div
          class="btn-group translate-body"
          role="group"
          aria-label="Basic radio toggle button group"
        >
          <div
            class="language shadow-sm bg-white rounded"
          ...
          >
            <input
              type="radio"
              class="btn-check"
              v-model="searchData.language_id"
        ...
        <div class="col-md-3">
          <div class="translate-left-sidebar">
            ...
            <div v-if="suggestedWords.length > 0" class="suggested-words">
              ...
              <div
                @click="searchSuggestedWords(suggestedWord.word)"
                class="result search_data translate-body"
                v-for="(suggestedWord, index) in suggestedWords"
                :key="index"
              >
                <div class="search_content">
                  <div class="">
            ...
            <div v-if="suggestedWords.length == 0 && translates.length == 0">
              ...
              <div class="d-flex flex-wrap w-full">
                <div
                  ...
                  v-for="(topSearchWord, index) in topSearchWords"
                  :key="index"
                >
                  <button
                    div
                    @click="searchSuggestedWords(topSearchWord.word)"
        ...
        <div class="col-md-9">
          ...
          <div class="search_data translate-body">
            ...
            >
              <hr />
              <div
                class="icon_dot d-flex justify-content-between align-items-center"
              >
