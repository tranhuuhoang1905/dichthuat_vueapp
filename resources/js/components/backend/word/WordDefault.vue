                ...
                <div class="word-default-data  translate-body">
                    <div class="search_content">
                        <div class="box_mean">
                            ...
                            <p class="box_mean-description">Description: {{ word.description }}</p>
                            <router-link :to="{ name: 'edit-word', params: { id: word_id } }" class="btn btn-primary">Edit
                            </router-link>
                        </div>
                    </div>
                </div>
    ...
    created() {
        this.axios
            ...
            .then((response) => {
                ...
                this.word = response.data.word_default;
                this.word_id = this.word.id;
