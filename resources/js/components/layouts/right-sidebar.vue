    ...
    <div v-click-outside="config" class="right-bar">
      <div data-simplebar class="h-100">
        ...
        <div class="p-3">
          ...
          <hr class="mt-1" />
          <b-form-radio-group v-model="width" stacked>
          ...
          <div v-if="layout === 'horizontal'">
            ...
            <hr class="mt-1" />
            <b-form-radio-group v-model="topbar" stacked>
              <b-form-radio value="dark" class="mb-1">Dark</b-form-radio>
              <b-form-radio value="light" class="mb-1">Light</b-form-radio>
            </b-form-radio-group>
          </div>
          ...
          <b-form-checkbox v-model="loader" name="check-button" switch>Preloader</b-form-checkbox>
        </div>
        <!-- Settings -->
        <hr class="mt-0" />
        ...
        <div class="p-4">
          <div class="mb-2">
            <router-link to="//http://nazox.vuejs-light-h.themesdesign.in/" target="_blank">
              <img src="@resources/assets/images/layouts/layout-4.jpg" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>

          <div class="mb-2">
            <router-link to="//http://nazox.vuejs-dark-h.themesdesign.in/" target="_blank">
              <img src="@resources/assets/images/layouts/layout-5.jpg" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>

          <div class="mb-2">
            <router-link to="//http://nazox.vuejs-rtl-h.themesdesign.in/" target="_blank">
              <img src="@resources/assets/images/layouts/layout-6.jpg" class="img-fluid img-thumbnail" alt />
            </router-link>
          </div>
        </div>
      </div>
