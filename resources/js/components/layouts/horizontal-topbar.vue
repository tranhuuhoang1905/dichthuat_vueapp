  ...
  <header id="page-topbar">
    <div class="navbar-header">
      <div class="d-flex">
        ...
        <b-dropdown variant="black" class="dropdown-mega d-none d-lg-block ml-2" toggle-class="header-item"
          ...
          <div class="row">
              ...
              <div class="row">
                <div class="col-md-4">
                  ...
                  <ul class="list-unstyled megamenu-list">
                    <li>
                      <a href="javascript:void(0);">abcd</a>
                    </li>
            ...
            <div class="col-sm-4">
              <div class="row">
                ...
                <div class="col-sm-5">
                  <div>
                    <img src="@resources/assets/images/megamenu-img.png" alt class="img-fluid mx-auto d-block" />
                  </div>
                </div>
              </div>
            </div>
      ...
      <div class="d-flex">
        ...
        <b-dropdown variant="white" right toggle-class="header-item">
          <template v-slot:button-content>
            <img class src="@resources/assets/images/flags/us.jpg" alt="Header Language" height="16" />
          </template>
          <b-dropdown-item class="notify-item" v-for="(entry, i) in languages" :key="`Lang${i}`" :value="entry"
            ...
            <span class="align-middle">abcd</span>
          </b-dropdown-item>
        </b-dropdown>

        <b-dropdown class="d-none d-lg-inline-block d-lg-inline-block ml-1" menu-class="dropdown-menu-lg" right
            ...
            <div class="row no-gutters">
              <div class="col">
                <a class="dropdown-icon-item" href="javascript: void(0);">
                  <img src="@resources/assets/images/brands/github.png" alt="Github" />
                  <span>abcd</span>
                </a>
              </div>
            </div>
        ...
        <b-dropdown right menu-class="dropdown-menu-lg p-0" toggle-class="header-item noti-icon" variant="black">
          ...
          <simplebar style="max-height: 230px">
            ...
            <a href class="text-reset notification-item">
              <div class="media">
                <img src="@resources/assets/images/users/avatar-3.jpg" class="mr-3 rounded-circle avatar-xs"
                  alt="user-pic" />
                <div class="media-body">
                  <h6 class="mt-0 mb-1">
                    abcd
            ...
            <a href class="text-reset notification-item">
              <div class="media">
                <img src="@resources/assets/images/users/avatar-4.jpg" class="mr-3 rounded-circle avatar-xs"
                  alt="user-pic" />
                <div class="media-body">
                  <h6 class="mt-0 mb-1">
                    abcd
        ...
        <b-dropdown right variant="black" toggle-class="header-item" class="d-inline-block user-dropdown">
          <template v-slot:button-content>
            <img class="rounded-circle header-profile-user" src="@resources/assets/images/users/avatar-2.jpg"
              alt="Header Avatar" />
            <span class="d-none d-xl-inline-block ml-1">abcd</span>
